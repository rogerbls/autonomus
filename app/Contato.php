...
class Contato extends Model{
    ...
    protected $fillable = [
        'saudacao' , 'nome', 'telefone', 'email', 'data_nascimento', 'avatar', 'observacao'
    ];
    ...
    public function setAvatarAtribute($value){
        $filename = substr(md5(rand(100000,999999)),0,5) .'_'.$value->getClientOriginalFileName();
